...
//using LoadManager = Keedy.Common.Load.LoadManager;
//public class LoadTestMonoBehaviour : MonoBehaviour {

//	// Use this for initialization
//	void Start () {
//        mam = new Keedy.Common.Load.LoadManager();
//        mam.Init();
...
//            state = mam.CreateLoadTask(source.sceneDeps, OnTaskComplete, 0, Keedy.Common.Load.ELoaderType.WWW_LOADER);
//        }
...
//    ILoadState state;
//    Keedy.Common.Load.LoadManager mam;
//    SeceneSource source;
